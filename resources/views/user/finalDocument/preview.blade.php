...
<div class="form-container">
    ...
    <div class="registration-form" >
        <div class="header">
            ...
            <div class="top-bar">
                <div class="district-box">
                    ...
                    <span class="district-input">{{$user->city}} </span>
                </div>
            ...
            <div class="title-area">
                <div class="clc-seal-wrap">
                    <img src="{{ public_path('images/logo.PNG') }}" class="clc-logo" alt="Christ Land City Logo" />
                </div>
            ...
            <div class="meta-bar">
                <div class="meta-item">
                    ...
                    <span class="meta-input">{{ $application->registration_no }} </span>
                </div>
                <div class="meta-item">
                    <span class="meta-lbl">Security Code</span>
                    <span class="meta-input">{{ $application->security_code }} </span>
                </div>
            </div>
            ...
            <div class="logo-section">
                <div class="logo-left-group">
                    <img src="{{ public_path('images/img1.PNG') }}" class="amir-logo" alt="Amir Sultan Get Home Services" />
                </div>
                <div class="logo-amp">&amp;</div>
                <div class="logo-right-group">
                    <img src="{{ public_path('images/img2.PNG') }}" class="church-logo" alt="Methodist Church of Pakistan" />
                </div>
            </div>
        ...
        <div class="field-row">
            ...
            <span class="finput">{{ $user->name }} </span>
        </div>
        ...
        <div class="field-row">
            ...
            <div class="cnic-boxes">
                ...
                <span class="cd">-</span>
                    ...
                    <span class="cb">{{ $cnic[12] ?? '' }} </span>
            </div>

            <span class="fl so">S/o, D/O, W/O.</span>
            <span class="finput">{{ $application->guardian_name ?? '' }}</span>
        </div>

        <!-- Current Mailing Address -->
        <div class="field-row">
            <span class="fl">Current Mailing Address</span>
            <span class="finput">{{$application->current_mailing_address}}</span>
        </div>

        <!-- Permanent Mailing Address -->
        <div class="field-row">
            <span class="fl">Permanent Mailing Address</span>
            <span class="finput">{{$application->permanent_mailing_address}}</span>
        </div>

        <!-- Occupation + Email -->
        <div class="field-row">
            <span class="fl">Occupation</span>
            <span class="finput">{{$application->occupation}}</span>
        ...
        <div class="field-row">
            ...
            <span class="finput">{{$application->official_contact_number}}</span>
            <span class="fl gap">Mobile</span>
            <span class="finput">{{$application->mobile_number}}</span>
        </div>
        ...
        <div class="payment-section">
            ...
            <div class="pay-lines">
                ...
                <div class="pay-inline">
                    ...
                    <span class="finput">Eleven Thousand Rupees Only</span>
                </div>
                <div class="pay-bottom-row">
                    <div class="pay-dated">
                        <span class="pay-lbl">Dated:</span>
                        <span class="finput">{{  $application->payment_date}}</span>
                    </div>
                    <div class="total-box">
                        <span>Total Amount PKR</span>
                        <span class="finput">11000/-</span>
                ...
                <div class="abox">
                    ...
                    <div class="file-preview"
                        ...
                        @if($application->cnic_copy)
                            @php
                                $cnicFile = public_path('storage/' . $application->cnic_copy);
                ...
                <div class="abox">
                    ...
                    <div class="file-preview"
                        ...
                        @if($application->deposit_copy)
                            @php
                                $depositFile = public_path('storage/' . $application->deposit_copy);
        ...
        <div class="booking-row">
            ...
            <span class="finput bk-finput">{{  $application->booked_by }}</span>
            <span class="bk-lbl mgL">Date</span>
            <span class="finput bk-finput">{{  $application->booking_date }}</span>
            <span class="bk-lbl mgL">Applicant Signature</span>
            <span class="finput bk-finput">{{  $application->signature }}</span>
        </div>
        ...
        <div class="footer-strip">
            ...
            <div class="footer-header">
                ...
                <span class="box">{{ $application->registration_no }}</span>
            </div>
